...
\label{img2si_8py_source}\index{/home/Theo/Téléchargements/sae/SAE\_JEU/MinGL2\_IUT\_AIX-\/master/tools/img2si.py@{/home/Theo/Téléchargements/sae/SAE\_JEU/MinGL2\_IUT\_AIX-\/master/tools/img2si.py}}

\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00001}00001 \textcolor{comment}{\#!/usr/bin/env python3}}
...
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00028}00028 \textcolor{keyword}{def }is\_file\_si2(filePath):}
...
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00034}00034 \textcolor{keyword}{def }convert\_from\_si2(source, output):}
...
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00059}00059 \textcolor{keyword}{def }convert\_to\_si2(source, output):}
...
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00095}00095 \textcolor{keyword}{def }main():}
...
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00111}00111     isSourceSi2 = is\_file\_si2(source)}
...
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00114}00114         convert\_from\_si2(source, output)}
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00115}00115     \textcolor{keywordflow}{else}:}
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00116}00116         convert\_to\_si2(source, output)}
...
\DoxyCodeLine{\Hypertarget{img2si_8py_source_l00127}00127     main()}
