...
void Statue(MinGL &window, int Circle1, int Circle2, int mat_x, int mat_y){
    ...
    window << nsShape::Rectangle(nsGraphics::Vec2D((Circle1-wall_x),(Circle2-wall_y)), nsGraphics::Vec2D((Circle1+wall_x),(Circle2+wall_y)), nsGraphics::KGreen);// square
}
